...
function Projects(props) {
    ...
    let items = [
        {title: 'Food Delivery App', description: 'The food delivery app here mainly focuses on providing the possibility for a user to view a certain number of articles from a remote restaurant, be able to add them to a cart and launch the purchase. It also provides an admin side for order processing and new items addition', stacks: <p className='text-lg text-fromLogo mt-7 md:text-2xl'>HTML <FontAwesomeIcon icon={faCircleDot}/> CSS <FontAwesomeIcon icon={faCircleDot}/> ReactJs <FontAwesomeIcon icon={faCircleDot}/> Firebase <FontAwesomeIcon icon={faCircleDot}/></p>, image: foodApp, link: 'https://e-commerce-food-app-delta.vercel.app/' },
