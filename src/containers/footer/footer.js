...
function footer(props) {
    return (
        <footer id='footer' className='container pb-10 text-sm mx-auto mt-60 flex flex-col-reverse md:flex-row md:justify-between'>
            ...
            <h3 className='text-2xl text-center md:text-left'><a href='https://github.com/ddunia680' className='transition-all duration-500 hover:text-darkBlue hover:transition-all hover:duration-500'><FontAwesomeIcon icon={faGithub}/></a> <a href='https://twitter.com/Dunia_Dunia5' className='transition-all duration-500 hover:text-darkBlue hover:transition-all hover:duration-500'><FontAwesomeIcon icon={faTwitter}/></a>  <a href='https://www.linkedin.com/in/dunia-dunia-86750b256/' className='transition-all duration-500 hover:text-darkBlue hover:transition-all hover:duration-500'><FontAwesomeIcon icon={faLinkedin}/></a>  <a href='https://www.instagram.com/duniadunia18/' className='transition-all duration-500 hover:text-darkBlue hover:transition-all hover:duration-500'><FontAwesomeIcon icon={faInstagram}/></a></h3>
