...
function ProjectItem(props) {
    ...
    return (
        <motion.a ref={ref} animate={animate} href={props.link} target="_blank" className='w-[90%] md:w-[25rem] p-[1rem] backdrop-brightness-110 dark:backdrop-brightness-75 duration-75 rounded-3xl md:mx-[1rem] hover:backdrop-brightness-90 dark:hover:backdrop-brightness-150 hover:duration-75'>
